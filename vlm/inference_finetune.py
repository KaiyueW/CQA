...
TEST_JSON       = "../data/ChartQA_data/test/test_all_preprocessed.json"
...
TEST_HEATMAP    = "../data/saliency_maps/ChartQA_test_all" # the saliency map dir for inference, you can change to the one you want.
MAX_SAMPLES     = 100

KNN_JSON        = "./output/twostep_dinov2_openai_knn_fewshot_examples.json" # the retrieval results for few-shot examples.
...
def run_inference(model, samples, knn_json, num_shot, setting, use_saliency):
    ...
    for i, sample in enumerate(samples):
        ...
        if setting == "zeroshot":
            ...
            # print(f"heatmap for this question: {saliency_map}, original chart: {imgname}, prompt: {prompt}\n")
...
def main():
    ...
    parser.add_argument("--model", choices=["llava15", "chartr1", "internvl", "qwen3vl", "bespokeminchart", "internvl_finetuned_saliency", "qwen3vl_finetuned_baseline", "qwen3vl_finetuned_saliency", "internvl_finetuned_baseline"], default="llava15")
    ...
    output_path  = f"./finetune/{args.model}_{args.setting}_{saliency_tag}_all3200.json"
