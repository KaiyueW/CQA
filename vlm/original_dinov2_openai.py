...
def run(
    ...
    if cached_image_features is not None and os.path.exists(cached_image_features):
        ...
        cached_img_features = torch.load(cached_image_features)
    ...
    retriever = ChartQAKNNRetriever(
        ...
        cached_image_features=cached_img_features,
...
if __name__ == "__main__":
    ...
    run(
        ...
        output_json="output/twostep_dinov2_openai_knn_fewshot_examples.json",
        num_shots=8,
        image_topk=200,
