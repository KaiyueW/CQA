...
DATA_FILE="./data/train_all_saliency.jsonl"
OUTPUT_DIR="/ubc/cs/research/nlp-raid/students/kwang67/VisSalFormer/finetune/checkpoints/projector_llm/qwen3vl_saliency"
LOG_DIR="/ubc/cs/research/nlp-raid/students/kwang67/VisSalFormer/finetune/tb_logs/projector_llm/qwen3vl_saliency"

echo "=== Training qwen3vl_saliency ==="
echo "Model:  $MODEL_ID"
echo "Data:   $DATA_FILE"
